...
var Hud = new Class(
{
	...
	/******************* BOUNDARY WALLS AND HUD COMBO ***********/
        ...
        linksMain.setText('<font size="1"> <a href="<?php getenv("DOCUMENT_ROOT")?>/web/home/home.php"> HOME</a> </font>');

	linksLogout = new Shape     (60, y,60,  0,"","","","red","boundary");
        linksLogout.setText('<font size="1"> <a href="<?php getenv("DOCUMENT_ROOT")?>/web/login/login_form.php"> LOGOUT</a> </font>');
