...
var Hud = new Class(
{
	...
	/******************* BOUNDARY WALLS AND HUD COMBO ***********/
        var y = 35;
        this.mHome = new Shape(60, y,  0,  0,"","","","#F8CDF8","boundary");
        this.mHome.setText('<font size="1"> <a href="<?php getenv("DOCUMENT_ROOT")?>/web/home/home.php"> HOME</a> </font>');

	this.mLogout = new Shape     (60, y,60,  0,"","","","red","boundary");
        this.mLogout.setText('<font size="1"> <a href="<?php getenv("DOCUMENT_ROOT")?>/web/login/login_form.php"> LOGOUT</a> </font>');
	
	this.mUsername = new Shape     (120, y,120,  0,"","","","orange","boundary");
        this.mUsername.setText('<font size="2"> user : ' + username + '</font>');
        
	this.mLevel = new Shape(120, y,240,  0,"","","","yellow","boundary");
        this.mLevel.setText('<font size="2"> Level : ' + next_level + '</font>');

        this.mScore = new Shape    (120, y,360,  0,"","","","LawnGreen","boundary");
        this.mScore.setText('<font size="2"> Score : </font>');

        this.mScoreNeeded = new Shape    (120, y,480,  0,"","","","cyan","boundary");

        this.mGameName = new Shape (170, y,600,  0,"","","","#F8CDF8","boundary");
        ...
        this.mQuestion = new Shape (770, y,  0,405,"","","","violet","boundary");
